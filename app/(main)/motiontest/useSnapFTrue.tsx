...
import { BoundingBox, MotionProps, DragHandlers, animate, SpringOptions, DragElastic, useAnimationControls } from "framer-motion";
...
export const useSnapFTrue = ({
    ...
    const [currentSnappointIndex, setCurrentSnappointIndex] = useState<null | number>(initialSnapPoint);
